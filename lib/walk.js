...
module.exports = function(opt){
    ...
    var STYLE_FILTERS = opt.styleFilters || [
            ...
            'text-decoration', 'text-indent', 'text-shadow', 'vertical-align',
            'visibility', 'position', 'z-index', 'transform', 'transition', '-webkit-line-clamp',
            // flexbox
            'justify-content', 'align-items', 'align-self', 'flex', 'flex-grow',
            'flex-shrink', 'flex-basis', 'flex-flow', 'flex-wrap', 'flex-direction', 'order',
            // grid
